...
- [ ] T013 [agent] [status:todo] When Phase 2 needs to append a decision but `planning/architecture.md` doesn't exist yet, create it using the type-keyed header template `skills/start/SKILL.md` Phase 1 defines (software/marketing/operations/research/other), not generic ad-hoc headers
