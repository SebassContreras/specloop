...
| T4 | Add root `README.md` (public-facing: what/install/quickstart/license, links to `planning/`) | agent | done |  |
...
| T7 | Flip GitHub repo visibility to public | human | done | Done 2026-09-03 via `gh repo edit --visibility public`. Sole collaborator (`SebassContreras`), no branch protection on `main` — irrelevant while no one else has write access. |
