...
1. If the user named a spec, resolve it against `planning/roadmap.md`. Otherwise list
...
Read `requirements.md`, `design.md`, and (if non-stub) `planning/architecture.md`. Draft
