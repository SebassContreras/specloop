...
- [ ] T004 [agent] [status:todo] Verify AC1/AC2: once T003 is done, push a real change touching `planning/roadmap.md` or a spec's `tasks.md`, confirm the workflow run succeeds in Actions and the published Pages URL reflects that change
