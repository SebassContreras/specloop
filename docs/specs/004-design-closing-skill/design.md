...
1. If the user named a spec (`NNN` or a kebab-case name), resolve it against
   `docs/roadmap.md`. Otherwise list rows from `docs/roadmap.md` with status `todo` or
...
3. Read `docs/architecture.md` for stack/convention context (if it exists and isn't a
